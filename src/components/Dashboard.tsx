...
interface DashboardProps {
  ...
  siteData: any;
  onSaveSiteData: (newData: any) => Promise<boolean>;
}
...
export default function Dashboard({
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-10" id="student-dashboard">
      ...
      <div className="flex gap-2 mb-8 border-b border-gray-150 pb-2.5">
        <button
          onClick={() => setDashboardMode('student')}
          className={`px-5 py-2.5 font-sans text-xs font-black uppercase tracking-wide rounded-xl transition-all cursor-pointer ${
            dashboardMode === 'student'
              ? 'text-[#226D7A] bg-[#226D7A]/5 shadow-sm border-b border-[#226D7A]'
        ...
        <button
          ...
          className={`px-5 py-2.5 font-sans text-xs font-black uppercase tracking-wide rounded-xl transition-all cursor-pointer ${
            dashboardMode === 'admin'
              ? 'text-[#a73918] bg-[#a73918]/5 shadow-sm border-b border-[#a73918]'
              : 'text-gray-500 hover:text-gray-800'
          }`}
          id="dashboard-admin-tab"
        >
          ⚙️ Administración del Sitio
        </button>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 space-y-8 text-left">
              ...
              <div className="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
                ...
                <div className="space-y-4 font-sans text-xs font-medium text-gray-600">
                  <div>
      ...
      {dashboardMode === 'admin' && siteData && (
        <div className="animate-fadeIn">
          <AdminPanel initialData={siteData} onSave={onSaveSiteData} />
        </div>
      )}
